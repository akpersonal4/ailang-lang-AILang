...
def analyze_context_for_ailang_understanding() -> dict:
    ...
    required_knowledge = {
        ...
        "no_forward_references": "forward references" in context
        or "No forward references" in context,
        "no_nested_functions": "nested functions" in context
        or "No nested functions" in context,
        "deterministic": "Deterministic" in context,
        "compiler_architecture": "Compiler Architecture" in context,
        "runtime_optimization": "RTO-001" in context
        or "Runtime Optimization" in context,
...
def analyze_context_for_todo_app() -> dict:
    ...
    requirements = {
        ...
        "missing_functions_warning": "Missing functions" in context
        or "split" in context
        or "find" in context,
    }
