...
def test_seed_all():
    tsProd = {"id": "SEED-PROD-1", "name": "Seed Test Product 1", "unit_price": 100}
    storage_add("products", tsProd)
    tsProd2 = {"id": "SEED-PROD-2", "name": "Seed Test Product 2", "unit_price": 50}
    storage_add("products", tsProd2)
    tsCust = {"id": "SEED-CUST-1", "name": "Seed Customer"}
    storage_add("customers", tsCust)
    tsSalesOrder = {"id": "SEED-SO-1", "customer_id": "SEED-CUST-1", "total": 500}
    storage_add("sales_orders", tsSalesOrder)
    tsSalesOrder2 = {"id": "SEED-SO-2", "customer_id": "SEED-CUST-1", "total": 1000}
