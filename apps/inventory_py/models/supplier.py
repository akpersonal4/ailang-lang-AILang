...
from core.storage import storage_add, storage_get_by_id, storage_update, storage_list

def supplier_create(spName, spContactPerson, spEmail, spPhone, spAddress, spPaymentTerms, spLeadTimeDays, spRating):
...
def supplier_search(spSearchTerm):
    ...
    for spItem in spAll:
        ...
        if spTermLower in spName.lower() or spTermLower in spContact.lower() or spTermLower in spEmail.lower():
